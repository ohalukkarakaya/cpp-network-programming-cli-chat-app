...
void join_a_room(const std::string& main_user_id, const std::string& server_ip, std::string& ip_address, bool is_test = false, const std::string& test_room_id = "test_room");
